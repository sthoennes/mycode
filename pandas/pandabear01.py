...
def main():
    ...
    # can be pd.json or pd.whatever for any type file you want to read in
...
#main()
    ...
    # number of rows and columns (5042, 24) - yuck big spreadsheet
    print(movies.shape)

    # sort DataFrame based on Gross Earnings - this will give top movies by earnings
